    ...
    <div className="inventory-page">
      <div className="container">
        ...
        <div className="generate-section">
          <h3>Generate Outfit Suggestions</h3>
          <p>Use AI to create outfit combinations from your wardrobe! (Includes sample items for testing)</p>
          <button 
          ...
          {items.length < 3 && <p className="hint">Add at least 3 items to generate outfits</p>}
        </div>
          ...
          <div className="outfits-section">
            ...
            {outfits.map((outfit, index) => (
              <div key={index} className="outfit-card">
                <h4>Outfit {index + 1} (Score: {outfit.score})</h4>
        ...
        <div className="items-section">
          ...
          <p className="sample-note">💡 Sample items are included for testing the outfit generator</p>
          {loading ? (
